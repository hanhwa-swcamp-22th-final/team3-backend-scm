 ...
 * 각 공장 라인에 배치된 기술자의 티어 분포와 권장 배치 인원을 제공하여
 * 팀 리더가 인력 불균형을 파악하고 재배치 계획을 세우는 데 활용한다.
 * GET /api/v1/scm/assignments/rebalance 에서 반환한다.
 */
@Getter
@NoArgsConstructor
@AllArgsConstructor
public class AssignmentRebalanceDto {
    ...
    private Integer totalTechnicianCount; // 라인에 배치된 기술자 총수
