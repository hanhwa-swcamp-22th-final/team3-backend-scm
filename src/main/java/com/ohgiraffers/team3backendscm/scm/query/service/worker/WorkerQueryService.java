...
/**
 * ?‘ì—…??Worker) ê¶Œí•œ??ë³¸ì¸ ?´ë ¥ ì¡°íšŒ Query ?œë¹„??
 * WorkerMapper ë¥??µí•´ ?‘ì—…???ì‹ ???¤ë¹„ ë°°ì¹˜ ?´ë ¥ê³?ì£¼ë¬¸ ë°°ì • ?´ë ¥???½ê¸° ?„ìš©?¼ë¡œ ?œê³µ?œë‹¤.
 */
@Service
...
public class WorkerQueryService {
    ...
    /**
     * ?¹ì • ?‘ì—…?ì˜ ë¯¸ì™„ë£??‘ì—… ëª©ë¡??ì¡°íšŒ?œë‹¤.
     * ? ì§œ ë¬´ê??˜ê²Œ REJECTÂ·COMPLETE ?íƒœë¥??œì™¸???„ì²´ ë°°ì • ?‘ì—…??ë°˜í™˜?œë‹¤.
     *
     * @param employeeId ì¡°íšŒ???‘ì—…??ì§ì›) ID
     * @return ë¯¸ì™„ë£??‘ì—… ëª©ë¡
     */
    ...
    /**
     * ?¹ì • ?‘ì—…?ì˜ ì£¼ë¬¸ ë°°ì • ?´ë ¥??ì¡°íšŒ?œë‹¤.
     *
     * @param employeeId ì¡°íšŒ???‘ì—…??ì§ì›) ID
     * @return ì£¼ë¬¸ ë°°ì • ?´ë ¥ ëª©ë¡
     */
    ...
    /**
     * ?¹ì • ?‘ì—…?ì˜ ?íƒœë³??‘ì—… ?˜ë? ì§‘ê³„?œë‹¤.
     * CONFIRMÂ·INPROGRESSÂ·COMPLETE ?íƒœë³?ì¹´ìš´?¸ë? ë°˜í™˜?œë‹¤.
     *
     * @param employeeId ì¡°íšŒ???‘ì—…??ì§ì›) ID
     * @return ?íƒœë³??‘ì—… ??ì§‘ê³„ DTO
     */
