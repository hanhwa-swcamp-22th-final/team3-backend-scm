 ...
 * 팀 리더가 주문에 배정할 기술자를 선택할 때 제공되는 후보 목록의 각 항목으로,
 * 역량 티어, OCSA 점수, 해당 주문에 대한 적합도 점수를 포함한다.
 * GET /api/v1/scm/assignments/candidates 에서 반환된다.
 */
@Getter
@NoArgsConstructor
@AllArgsConstructor
public class AssignmentCandidateDto {
    ...
    private String tier;              // 역량 티어 (S / A / B / C)
    private BigDecimal score;         // 기술자의 OCSA 역량 점수
