 ...
 * 납기 위험 주문 수, 달성률, 칸반 컬럼별 카운트를 제공한다.
 */
@Getter
@NoArgsConstructor
@AllArgsConstructor
public class OrderSummaryDto {
    ...
    private Double achievementRate;    // 전체 대비 완료 주문 달성률 (0.0~100.0)
    private Integer registeredCount;   // 등록(REGISTERED) 상태 주문 수 — 칸반 1열
    private Integer analyzedCount;     // 분석완료(ANALYZED) 상태 주문 수 — 칸반 2열
    private Integer completedCount;    // 완료(COMPLETED) 상태 주문 수 — 칸반 3열
}
