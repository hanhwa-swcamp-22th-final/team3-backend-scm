 ...
 *   <li>GET /facilities/{facilityId}/history      - 특정 설비 이벤트 이력 조회</li>
 *   <li>GET /facilities/{facilityId}/deployments  - 특정 설비 배치 인원 조회</li>
 *   <li>GET /facilities/summary                   - 전체 설비 현황 요약 조회</li>
 *   <li>GET /facilities/{facilityId}/trends       - 특정 설비 환경 트렌드 조회</li>
 * </ul>
 * </p>
 */
@RestController
